...
from modules import RNNEncoder, SimpleSoftmaxLayer, BasicAttn, SelfAttn, DotAttn
...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        if self.FLAGS.gated_reps:
            gated_reps_layer = GatedReps(self.FLAGS.hidden_size*4)
            gated_blended_reps = gated_reps_layer.build_graph(blended_reps)
        else:
            gated_blended_reps = blended_reps
        """
