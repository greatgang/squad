...
class RNNEncoder(object):
    ...
    def __init__(self, hidden_size, keep_prob, n_encoder_layers):
        """
        Inputs:
        ...
        self.rnn_cell_fw = MultiRNNCell([self.rnn_cell_fw] * self.n_encoder_layers)
        self.rnn_cell_bw = rnn_cell.GRUCell(self.hidden_size)
        self.rnn_cell_bw = DropoutWrapper(self.rnn_cell_bw, input_keep_prob=self.keep_prob)
        self.rnn_cell_bw = MultiRNNCell([self.rnn_cell_bw] * self.n_encoder_layers)
